require("utils").add_ui_ft("OverseerForm", "OverseerList")
...
return {
  ...
  keys = {
    ...
    { "<leader>rc", "<cmd>OverseerRunCmd<cr>", desc = "Overseer: Run cmd" },
    { "<leader>rl", "<cmd>OverseerRestartLast<cr>", desc = "Overseer: Run Last" },
    { "<leader>ri", "<cmd>OverseerInfo<cr>", desc = "Overseer: Info" },
    { "<leader>ru", "<cmd>OverseerToggle<cr>", desc = "Overseer: Toggle" },
  },
}
