  ...
  opts = {
    ...
    symbols = {
      ...
      icons = {
        ...
        Namespace = { icon = icons.kind.Module, hl = "BlinkCmpKindModule" },
        Package = { icon = icons.kind.Module, hl = "BlinkCmpKindModule" },
        ...
        String = { icon = icons.kind.String, hl = "BlinkCmpKindField" },
        Number = { icon = icons.kind.Number, hl = "BlinkCmpKindValue" },
        Boolean = { icon = icons.kind.Boolean, hl = "BlinkCmpKindValue" },
        Array = { icon = icons.kind.Array, hl = "BlinkCmpKindValue" },
        Object = { icon = icons.kind.Object, hl = "BlinkCmpKindValue" },
