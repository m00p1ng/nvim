...
return {
  ...
  opts = {
    ...
    symbols = {
      ...
      icons = {
        File = { icon = icons.kind.File, hl = "BlinkCmpKindFile" },
        Module = { icon = icons.kind.Module, hl = "BlinkCmpKindModule" },
        Namespace = { icon = icons.kind.Module, hl = "BlinkCmpKindNamespace" },
        Package = { icon = icons.kind.Module, hl = "BlinkCmpKindPackage" },
        Class = { icon = icons.kind.Class, hl = "BlinkCmpKindClass" },
        Method = { icon = icons.kind.Method, hl = "BlinkCmpKindMethod" },
        Property = { icon = icons.kind.Property, hl = "BlinkCmpKindProperty" },
        Field = { icon = icons.kind.Field, hl = "BlinkCmpKindField" },
        Constructor = { icon = icons.kind.Constructor, hl = "BlinkCmpKindConstructor" },
        Enum = { icon = icons.kind.Enum, hl = "BlinkCmpKindEnum" },
        Interface = { icon = icons.kind.Interface, hl = "BlinkCmpKindInterface" },
        Function = { icon = icons.kind.Function, hl = "BlinkCmpKindFunction" },
        Variable = { icon = icons.kind.Variable, hl = "BlinkCmpKindVariable" },
        Constant = { icon = icons.kind.Constant, hl = "BlinkCmpKindConstant" },
        String = { icon = icons.kind.String, hl = "BlinkCmpKindString" },
        Number = { icon = icons.kind.Number, hl = "BlinkCmpKindNumber" },
        Boolean = { icon = icons.kind.Boolean, hl = "BlinkCmpKindBoolean" },
        Array = { icon = icons.kind.Array, hl = "BlinkCmpKindArray" },
        Object = { icon = icons.kind.Object, hl = "BlinkCmpKindObject" },
        Key = { icon = icons.kind.Keyword, hl = "BlinkCmpKindKeyword" },
        Null = { icon = icons.kind.Null, hl = "BlinkCmpKindNull" },
        EnumMember = { icon = icons.kind.EnumMember, hl = "BlinkCmpKindEnumMember" },
        Struct = { icon = icons.kind.Struct, hl = "BlinkCmpKindStruct" },
        Event = { icon = icons.kind.Event, hl = "BlinkCmpKindEvent" },
        Operator = { icon = icons.kind.Operator, hl = "BlinkCmpKindOperator" },
        TypeParameter = { icon = icons.kind.TypeParameter, hl = "BlinkCmpKindTypeParameter" },
