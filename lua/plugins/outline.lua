...
return {
  ...
  opts = {
    ...
    symbols = {
      ...
      icons = {
        File = { icon = icons.kind.File, hl = "NavicIconsFile" },
        Module = { icon = icons.kind.Module, hl = "NavicIconsModule" },
        Namespace = { icon = icons.kind.Module, hl = "NavicIconsNamespace" },
        Package = { icon = icons.kind.Module, hl = "NavicIconsPackage" },
        Class = { icon = icons.kind.Class, hl = "NavicIconsClass" },
        Method = { icon = icons.kind.Method, hl = "NavicIconsMethod" },
        Property = { icon = icons.kind.Property, hl = "NavicIconsProperty" },
        Field = { icon = icons.kind.Field, hl = "NavicIconsField" },
        Constructor = { icon = icons.kind.Constructor, hl = "NavicIconsConstructor" },
        Enum = { icon = icons.kind.Enum, hl = "NavicIconsEnum" },
        Interface = { icon = icons.kind.Interface, hl = "NavicIconsInterface" },
        Function = { icon = icons.kind.Function, hl = "NavicIconsFunction" },
        Variable = { icon = icons.kind.Variable, hl = "NavicIconsVariable" },
        Constant = { icon = icons.kind.Constant, hl = "NavicIconsConstant" },
        String = { icon = icons.kind.String, hl = "NavicIconsString" },
        Number = { icon = icons.kind.Number, hl = "NavicIconsNumber" },
        Boolean = { icon = icons.kind.Boolean, hl = "NavicIconsBoolean" },
        Array = { icon = icons.kind.Array, hl = "NavicIconsArray" },
        Object = { icon = icons.kind.Object, hl = "NavicIconsObject" },
        Key = { icon = icons.kind.Keyword, hl = "NavicIconsKeyword" },
        Null = { icon = icons.kind.Null, hl = "NavicIconsNull" },
        EnumMember = { icon = icons.kind.EnumMember, hl = "NavicIconsEnumMember" },
        Struct = { icon = icons.kind.Struct, hl = "NavicIconsStruct" },
        Event = { icon = icons.kind.Event, hl = "NavicIconsEvent" },
        Operator = { icon = icons.kind.Operator, hl = "NavicIconsOperator" },
        TypeParameter = { icon = icons.kind.TypeParameter, hl = "NavicIconsTypeParameter" },
